...
from .general import _iter_sections, _unescape_delimiter


def _slice_text_by_tokens(text: str, max_tokens: int, overlap_tokens: int) -> list[str]:  # ruff:ignore[complex-structure]
    if max_tokens <= 0:
