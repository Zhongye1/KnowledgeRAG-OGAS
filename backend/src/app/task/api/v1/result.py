...
from backend.src.app.task.schema.result import DeleteTaskResultParam, GetTaskResultDetail
from backend.src.app.task.service.result_service import task_result_service
