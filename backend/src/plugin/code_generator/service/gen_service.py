...
from backend.src.plugin.code_generator.crud.crud_gen import gen_dao
from backend.src.plugin.code_generator.model import GenBusiness
from backend.src.plugin.code_generator.schema.business import CreateGenBusinessParam
from backend.src.plugin.code_generator.schema.column import CreateGenColumnInternalParam
from backend.src.plugin.code_generator.schema.gen import ImportParam
from backend.src.plugin.code_generator.service.column_service import gen_column_service
from backend.src.plugin.code_generator.utils.format_code import format_python_code
from backend.src.plugin.code_generator.utils.gen_template import gen_template
from backend.src.plugin.code_generator.utils.type_conversion import sql_type_to_pydantic
from backend.src.utils.locks import acquire_distributed_reload_lock
...
class GenService:
    ...
    async def _inject_app_router(*, app_name: str, write: bool = True) -> str | None:
        ...
        import_line = f'from backend.src.app.{app_name}.api.router import v1 as {app_name}_v1'
