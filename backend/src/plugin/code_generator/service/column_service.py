...
from backend.src.plugin.code_generator.model import GenColumn
from backend.src.plugin.code_generator.schema.column import CreateGenColumnParam, UpdateGenColumnParam
