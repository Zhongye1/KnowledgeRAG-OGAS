...
from backend.src.plugin.status import get_plugin_enable
from backend.src.plugin.validator import validate_plugin_config
from backend.src.utils.async_helper import run_await
from backend.src.utils.dynamic_import import get_model_objects
...
def get_plugin_models() -> list[object]:
    ...
    for plugin in get_plugins():
        module_path = f'backend.src.plugin.{plugin}.model'
