...
from backend.src.core.register import register_app
from backend.src.plugin.core import check_required_plugins, get_plugins
from backend.src.plugin.requirements import install_requirements
from backend.src.utils.console import console
