...
const AttachmentRemove: FC = () => {
  return (
    <AttachmentPrimitive.Remove asChild>
      <TooltipIconButton
        tooltip="Remove file"
        className="aui-attachment-tile-remove absolute end-1 top-1 size-5 rounded-full bg-color-text-1/50! text-color-bg-1! after:absolute after:-inset-1.5 hover:bg-color-text-1/70! hover:text-color-bg-1! active:scale-[0.96] motion-reduce:transition-none"
        side="top"
      >
