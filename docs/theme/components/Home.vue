...
import ragFlowImg from './20260829_011914.png'
import retrieverImg from '../../RAG_core/assets/01_RAG核心的设计总览-1787688734939.png'

const GITHUB = 'https://github.com/Zhongye1/KnowledgeRAG-GZHU'
...
const enterprise = [
  ...
  { icon: 'layers', title: '一键部署', desc: 'Docker Compose 快速拉起前后端与依赖服务，私有化开箱即用。' }
]
    ...
    <section class="yx-hero">
      ...
      <div class="yx-container yx-hero__inner">
        <div class="yx-hero__copy">
          <span class="yx-badge">KnowledgeRAG · MIT 开源 · 可私有部署</span>
          ...
          <div class="yx-hero__actions">
            <a class="yx-btn yx-btn--primary" :href="withBase('/开始/')">快速开始</a>
    ...
    <section class="yx-section">
      <div class="yx-container">
        <header v-reveal class="yx-head">
          ...
          <p class="yx-head__sub">KnowledgeRAG 内置一套完整的运行时——解析、检索、技能与中间件编排，让智能体真正动手完成任务。</p>
        </header>
        <div class="yx-bento">
          <article
      ...
      <div class="yx-container">
        ...
        <div class="yx-shots">
          <figure v-for="sh in shots" :key="sh.title" v-reveal class="yx-shot">
            <img v-if="sh.image" :src="sh.image" :alt="sh.title" loading="lazy" />
            <div v-else class="yx-placeholder" role="img" :aria-label="sh.title + ' 预览'">
...
<span class="yx-c-cmt"># 2. 使用 Docker Compose 启动</span>
docker-compose up -d

<span class="yx-c-cmt"># 3. 浏览器访问</span>
open http://localhost:8080</code></pre>
          <p class="yx-quick__tip">完整部署与配置方式见「工程治理 → 构建与部署」文档。</p>
        </div>
      </div>
    </section>
    ...
    <section class="yx-section yx-section--soft">
      <div class="yx-container yx-center">
        ...
        <a v-reveal :href="GITHUB + '/graphs/contributors'" target="_blank" rel="noreferrer" class="yx-contrib">
          <img src="https://contrib.rocks/image?repo=Zhongye1/KnowledgeRAG-GZHU&max=60&columns=12" alt="KnowledgeRAG 贡献者头像墙" loading="lazy" />
        </a>
...
.yx-home {
  --yx-max: 1152px;
  --yx-gap: 24px;
  --yx-brand: var(--vp-c-brand-1);
  --yx-brand-hover: var(--vp-c-brand-2);
