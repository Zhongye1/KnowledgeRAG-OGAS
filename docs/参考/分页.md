基于 `fastapi-pagination` 封装了统一分页能力，核心实现位于 `backend/src/common/pagination.py`
...
```python
from backend.src.common.pagination import CursorPageData, DependsCursorPagination
from backend.src.common.response.response_schema import ResponseSchemaModel, response_base
from backend.src.database.db import CurrentSession
